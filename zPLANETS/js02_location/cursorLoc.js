...
function startCursorLoc()
{
    ...
    d3.select("#planetSVG").on("mousemove", function()
        {
            ...
            if(addElemImageViz==true)trackDrawImage()
               ...
               // if(ShowDistance==true)trackDistance()
                ...
                LatLng = PlanetProjection.invert(d3.mouse(this))
             ...
             if(LatLngPntSet==false && !isNaN(ra)&&!isNaN(dec))
            {
               var scale=PlanetView.k
               if(scale<=1000)
                 {
                    raValue.value = ra.toFixed(3)
                    decValue.value = dec.toFixed(3)
                 }
                else if(scale<2000)
                 {
                    raValue.value = ra.toFixed(5)
                    decValue.value = dec.toFixed(5)
                 }
                else if(scale<3000)
                 {
                    raValue.value = ra.toFixed(7)
                    decValue.value = dec.toFixed(7)
                 }
                else
                 {
                    raValue.value = ra.toFixed(9)
                    decValue.value = dec.toFixed(9)
                 }
...
function stopCursorLoc()
{
    ...
    d3.select("#planetSVG").on("mousemove", null)
}
