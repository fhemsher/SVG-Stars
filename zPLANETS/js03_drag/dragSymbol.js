         ...
         var t3=d3.transform(ActiveElem.attr("transform"))
          ...
          var transY=t3.translate[1]
           ActiveLL=StarProjection.invert([transX,transY])
            ...
            var alignX=PrevPlanetTransX+(ActiveElemEndTrans[0]-ActiveElemStartTrans[0])/StarView.k
            var alignY=PrevPlanetTransY+(ActiveElemEndTrans[1]-ActiveElemStartTrans[1])/StarView.k
