        ...
        if(LatLngPntSet==false)
                {
                        ...
                        var alignX=PrevTransX+(ActiveElemEndTrans[0]-ActiveElemStartTrans[0])/PlanetView.k
                        var alignY=PrevTransY+(ActiveElemEndTrans[1]-ActiveElemStartTrans[1])/PlanetView.k
