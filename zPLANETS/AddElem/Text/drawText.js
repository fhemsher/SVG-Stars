...
function startTextDraw()
{
    ...
    planetSVG.setAttribute('onclick', "placeDrawText()")
    RotateAngle = 0
    TspanCnt = 0;
    TSpanON = true;
    InsertSpanON = false
...
function placeDrawText()
{
    ...
    startBlinker()
    planetSVG.setAttribute("onmousedown", "startDragText(evt)")
    planetSVG.setAttribute("onmousemove", "dragText(evt)")
    planetSVG.setAttribute("onmouseup", "endDragText(evt);addElemTextCw.focusText()")
            ...
            else if(document.getElementById("activeElem"))
            {
                ...
                finishedElem.attr("createdBy", oEMAIL)
                 ...
                 var t3 = d3.transform(finishedElem.attr("transform"))
                   ...
                   finishedElem.attr("transform", PlanetPoint(ll)+"scale("+(PlanetView.k/PlanetScale)/ActiveScale+")"+rotate)
                ...
                planetSVG.setAttribute('onclick', "placeDrawText()") //---click to add more icons for this session---
                DrawX.style("display", "none")
    ...
    {       removeNoSelectAtText()
        ...
        if(rotateAngle!=0)
            rotate = "rotate("+rotateAngle+")"
             ...
             var ll = ActiveLL
            finishedElem.setAttribute("transform", PlanetPoint(ll)+"scale("+(PlanetView.k/PlanetScale)/ActiveScale+")"+rotate)
