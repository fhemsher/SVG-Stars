...
function regPolyCircleRad(vCnt, radius, centerX, centerY)
{
    if(activeElem)
    {
        ...
        for(var v = 0; v<vCnt; v++)
        {
            var point = planetSVG.createSVGPoint();
...
function closeDrawPolygon()
{
    if(addElemPolygonViz==true)
    {
        ...
        {
            planetSVG.appendChild(dragDot) //--place drag dot on top---
...
function startPolygonDraw()
{
    ...
    if(EditPolygon==false)
    {
        ...
        DrawPolygon = true
        DrawX.style("display", "inline")
        planetSVG.setAttribute('onclick', "placeDrawPolygon()") //---click to add more icons for this session---
...
function placeDrawPolygon()
{
    ...
    if(cw.drawPolygonShadowCheck.checked==true)
        ...
        planetSVG.setAttribute("onmousedown", "startDragPolygon(evt)")
        planetSVG.setAttribute("onmousemove", "dragPolygon(evt)")
        planetSVG.setAttribute("onmouseup", "endDragPolygon(evt)")
...
function resetEditPolygon()
{
    ...
    cw.drawPolygonFinishButton.disabled = false
    DrawPolygon = true
    planetSVG.setAttribute('onclick', "placeDrawPolygon()")
