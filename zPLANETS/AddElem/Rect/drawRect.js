...
function startRectDraw()
{
    ...
    if(EditRect==false)
    {
        ...
        ActiveElem = null
        DrawRect = true
        planetSVG.setAttribute('onclick', " placeDrawRect()") //---click to add more icons for this session---
        DrawX.style("display", "inline")
    }
...
function placeDrawRect()
{
    ...
    DrawX.attr("stroke", "violet")
        ...
        DragDot.attr("transform", "translate("+(50)+" "+(50)+")")
        DragDot.attr("cx", null)

        planetSVG.removeAttribute('onclick')

        planetSVG.setAttribute("onmousedown", "startDragRect(evt)")
        planetSVG.setAttribute("onmousemove", "dragRect(evt)")
        planetSVG.setAttribute("onmouseup", "endDragRect(evt)")
...
function resetEditRect()
{
    ...
    cw.drawRectFinishButton.disabled = false
    DrawRect = true
    planetSVG.setAttribute('onclick', " placeDrawRect()")
