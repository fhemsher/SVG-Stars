...
function startImageDraw()
{
    ...
    if(EditImage==false)
    {
        ...
        DrawImage = true
        DrawX.style("display", "inline")
       planetSVG.setAttribute('onclick', "placeDrawImage()") //---click to add more icons for this session---
        cw.drawImageTopButton.style.visibility = "hidden"
   planetSVG.setAttribute("cursor","default")
...
function placeDrawImage()
{
    ...
    if(cw.imgFile.value!="")
    {
       ...
       planetSVG.setAttribute("onmousedown", "startDragImage(evt)")
       planetSVG.setAttribute("onmousemove", "dragImage(evt)")
       planetSVG.setAttribute("onmouseup", "endDragImage(evt)")
    ...
    if(addElemImageViz==true)
    {
       ...
       planetSVG.removeAttribute('onclick')
        if(document.getElementById("activeElem"))
        {
           ...
           planetSVG.appendChild(imgDragArrow) //--place drag dot on top---
        ...
        imgDragArrow.setAttribute("x",-25)
        imgDragArrow.setAttribute("y",-25)
    ...
    if(EditImage==true)
        ...
        else if(document.getElementById("activeElem"))
        {
          ...
          //  finishedElem.setAttribute("onmousedown", "editImageDraw("+id+",evt)")
                     ...
                     var myScale = (PlanetView.k/PlanetScale)/(ActiveScale)
            ...
            finishedElem.setAttribute("myScale", myScale)
...
function finishEditImage()
{
    ...
    if(document.getElementById("activeElem"))
    {
        ...
        planetSVG.appendChild(imgDragArrow)
        ...
        finishedElem.setAttribute("transform", PlanetPoint(ActiveLL)+"scale("+(PlanetView.k/PlanetScale)/ActiveScale+")")
                ...
                var myScale = (PlanetView.k/PlanetScale)/(ActiveScale) // finishedElem.setAttribute("rotateAngle", rotateAngle)
                  finishedElem.setAttribute("myScale", myScale)
                        ...
                        for(var k = 0; k<AddElemCoordsArray.length; k++)
                        {
                                ...
                                if(addId==DrawImageEditId)
                                {
                                        ...
                                        AddElemCoordsArray[k] =[ll, ActiveScale, DrawImageEditId]
