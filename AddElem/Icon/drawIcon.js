...
{     DrawIcon=true
     coverOn()
    starSVG.setAttribute("onclick", "plantIcon(event)")
    StopStarZoom=true
}
    ...
    if(EditIcon==true)
        ...
        {coverOff()
            ...
            if(cw.drawIconFadeCheck.checked==true)
                ...
                AddElemCoordsArray.push([ll, ActiveScale, ActiveIconId, '', fade])
                ...
                finishedElem.setAttribute("createdBy", oEMAIL)
                    ...
                    starSVG.setAttribute('onclick', "plantIcon(event)") //---click to add more icons for this session---
