...
function placeDrawEllipse()
{
    ...
    starSVG.setAttribute("onmousedown", "startDragEllipse(evt)")
    starSVG.setAttribute("onmousemove", "dragEllipse(evt)") //;showStarComment(evt)
    starSVG.setAttribute("onmouseup", "endDragEllipse(evt)")
    ...
    if(EditEllipse==true)
        ...
        else if(document.getElementById("activeElem"))
        {
            ...
            if(rotateAngle!=0)
                ...
                if(cw.drawEllipseFadeCheck.checked==true)
...
function setEditEllipse()
{
    ...
    if(EditThisEllipse.getAttribute("comment"))
        ...
        var fade = EditEllipseObj.getAttribute("fade")
        if(fade)
        cw.drawEllipseFadeCheck.checked = true
        else
            cw.drawEllipseFadeCheck.checked = false
            ...
            cw.drawEllipseStrokeDashCheck.checked = true
                ...
                //---timeout??---
                starSVG.setAttribute("onmousedown", "startDragEllipse(evt)")
                starSVG.setAttribute("onmousemove", "dragEllipse(evt)")
                starSVG.setAttribute("onmouseup", "endDragEllipse(evt)")
...
function resetEditEllipse()
{
    ...
    cw.drawEllipseFinishButton.disabled = false
    DrawEllipse = true
    starSVG.setAttribute('onclick', "placeDrawEllipse()")
